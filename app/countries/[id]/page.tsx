...
export default function Country(){
    ...
    return(
        <div className="bg-[hsl(0, 0%, 50%)] min-h-screen dark:bg-gray-900 text-gray-950 dark:text-white">
            <header className="bg-[hsl(0, 0%, 99%)] dark:bg-gray-800 top-0 left-0 w-full flex justify-between px-[50px] max-sm:px-[20px] sticky py-[25px] border-b-[3px] border-gray-300">
