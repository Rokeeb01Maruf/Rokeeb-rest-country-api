    ...
    return(
        <div className="bg-gray-100 min-h-screen dark:bg-gray-800 px-[20px] text-gray-950 dark:text-white">
            ...
            <main className="px-12 mt-[50px]">
                <button onClick={()=>router.back()} className="dark:bg-gray-700 px-[24px] cursor-pointer rounded shadow-[0_0_10px_rgba(0,0,0,0.4)] py-1.5 bg-white">Back</button>
               <div className="flex justify-center">
                    {
                        country.map((e)=>(
                            <div key={e.capital} className="my-[50px] max-[900px]:gap-x-[5rem] gap-x-24 flex max-w-[100vw] justify-center max-[681px]:flex-col max-[681px]:align-middle max-[681px]:my-[20px] ">
