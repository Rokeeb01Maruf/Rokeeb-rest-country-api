    ...
    <div className="bg-[hsl(209, 23%, 22%)] min-h-screen dark:bg-gray-900 text-gray-800 dark:text-white max-w-screen">
      ...
      <main className="bg-[hsl(0, 0%, 99%)] dark:bg-[hsl(207, 26%, 17%)]">
        <div className="search items-center flex sticky bg-[hsl(0, 0%, 99%)] justify-between  left-0 dark:bg-gray-800 px-[clamp(20px,2.6vw,50px)]  sm:px-[20px] max-w-screen py-[25px] top-[75px]">
          <input type="search" placeholder="Search for a country..." id="" onChange={handleChange} className="dark:text-white dark:placeholder-white  dark:bg-gray-800 h-9.5 text-sm outline-0 pl-7.5 max-w-lg max-md:min-w-[350px] max-sm:max-w-[100] rounded relative leading-none shadow-[0_0_10px_rgba(0,0,0,0.4)] bg-white" />
