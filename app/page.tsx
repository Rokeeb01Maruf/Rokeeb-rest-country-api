...
export default function Home() {
  ...
  return (
    <div className="bg-[hsl(209, 23%, 22%)] min-h-screen dark:bg-[hsl(207, 26%, 17%)] text-gray-800 dark:text-white max-w-screen">
      ...
      <main className="bg-[hsl(0, 0%, 99%)] dark:bg-[hsl(207, 26%, 17%)]">
        <div className="search items-center flex sticky bg-[hsl(0, 0%, 99%)] justify-between  left-0 dark:[hsl(207, 26%, 17%)] px-[clamp(20px,2.6vw,50px)]  sm:px-[20px] max-w-screen py-[25px] top-[75px]">
          <input type="search" placeholder="Search for a country..." id="" onChange={handleChange} className="dark:text-white dark:placeholder-white  dark:bg-[hsl(209, 23%, 22%)] h-9.5 text-sm outline-0 pl-7.5 max-w-lg max-md:min-w-[350px] max-sm:min-w-[200px] rounded relative leading-none shadow-[0_0_10px_rgba(0,0,0,0.4)] bg-white" />
        ...
        <div className="man pt-[25px] grid grid-cols-4 px-[50px] gap-x-5 max-lg:grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1">
          {
            das.map((e:{name: string, region: string, capital: string, population: number, flags: {
              ...
              <div key={e.name} className="max-w-[260px] max-sm:mx-auto max-sm:max-w-[300px] max-sm:w-full pb-12 rounded bg-white mb-12 dark:bg-[hsl(209, 23%, 22%)]">
